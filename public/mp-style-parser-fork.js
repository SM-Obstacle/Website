...
Color = (function() {
  ...
  Color.nudgeDark = function(hex_color) {
    var b, g, grey, r;
    r = parseInt(hex_color[0], 16);
    g = parseInt(hex_color[1], 16);
    b = parseInt(hex_color[2], 16);
    grey = (0.2126 * r + 0.7152 * g + 0.0722 * b);
    if (grey < 4) {
      r = Math.min(15, Math.max(4, r * 2));
      g = Math.min(15, Math.max(4, g * 2));
      b = Math.min(15, Math.max(4, b * 2));
      return r.toString(16) + g.toString(16) + b.toString(16);
    }
    return hex_color;
  };
